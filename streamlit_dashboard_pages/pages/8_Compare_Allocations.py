...
from streamlit_dashboard_pages.shared import initialize_session_state, calculate_satisfaction_metrics, calculate_fairness_score, safe_set_page_config
...
safe_set_page_config(
    page_title="Compare Allocations - Thesis Allocation Dashboard",
    page_icon="⚖️",
    layout="wide"
)
